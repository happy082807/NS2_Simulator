...
set f(1) [open sfqout1.tr w]
set f(2) [open sfqout2.tr w]
set f(3) [open sfqout3.tr w]
set f(4) [open sfqout4.tr w]
set f(5) [open sfqout5.tr w]
$ns trace-all $tf
...
#Execute nam on the trace file
 exec nam drpout.nam &
 exec xgraph sfqout1.tr sfqout2.tr sfqout3.tr sfqout4.tr sfqout5.tr &
 exit 0
}
...
for {set j 1} {$j<=$NumbSrc} { incr j } {
    $ns duplex-link $n($j) $r($j) 5Mb 20ms SFQ
}

#Bandwidth 0.5Mbps, delay 100ms, DropTail
$ns duplex-link $n0 $r(1) 0.5Mb 100ms SFQ
$ns duplex-link $r(1) $r(2) 0.5Mb 100ms SFQ
$ns duplex-link $r(2) $r(3) 0.5Mb 100ms SFQ
$ns duplex-link $r(3) $r(4) 0.5Mb 100ms SFQ
$ns duplex-link $r(4) $r(5) 0.5Mb 100ms SFQ
